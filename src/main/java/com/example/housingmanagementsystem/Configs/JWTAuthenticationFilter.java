    ...
    protected void doFilterInternal(HttpServletRequest servletRequest,HttpServletResponse servletResponse,FilterChain filterChain) throws ServletException, IOException{
        ...
        if(authHeader!=null && authHeader.startsWith("Bearer ")){
            ...
            if(username!=null && SecurityContextHolder.getContext().getAuthentication()==null){
                //Fetch the user username,password and roles from DB
                ...
                if (jwtUtil.validateToken(jwt,userDetails)){
                    ...
                    //Adds extra request info(client IP,session ID) to the authentication object
        ...
        //Enables the request to continue through other filters available before reaching the controller
